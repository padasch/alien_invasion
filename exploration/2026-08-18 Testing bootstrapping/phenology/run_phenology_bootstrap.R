...
# Block-stratified, non-parametric container bootstrap for the phenology models.
# All outputs remain inside this exploration directory.
...
exploration_dir <- dirname(script_file)
...
project_root <- find_project_root(exploration_dir)
setwd(project_root)
...
figure_dir <- file.path(exploration_dir, "figures")
comparison_dir <- file.path(exploration_dir, "comparison")
...
message("Phenology bootstrap exploration saved in: ", normalizePath(exploration_dir, winslash = "/"))
