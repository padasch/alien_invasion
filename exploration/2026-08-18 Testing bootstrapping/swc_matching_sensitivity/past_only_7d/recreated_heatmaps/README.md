...
- `figure-s3-sem-path-decomposition-past-only-swc.pdf` should be compared with the current bootstrap version at `output/supplementary/figure-s3-sem-path-decomposition.pdf`.
