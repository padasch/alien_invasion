...
ALINV_FINAL_OUTPUT_DIR <- file.path(ALINV_FINAL_SCRIPT_DIR, "output")
...
suppressMessages(suppressPackageStartupMessages({
  source(file.path(ALINV_PROJECT_ROOT, "functions", "_source.R"))
  source(file.path(ALINV_PROJECT_ROOT, "functions", "1-summary-figures.R"))
  source(file.path(ALINV_PROJECT_ROOT, "functions", "2-biomass.R"))
  source(file.path(ALINV_PROJECT_ROOT, "functions", "3-effect-size-factorial.R"))
