...
# 
# # ============================================================
# # EXPLORATORY DATA ANALYSIS CODE - Commented out to prevent
# # execution during source(). Uncomment to run interactively.
# # ============================================================
# 
# # Meteo Data ----------------------------------------------------------------------------------
# 
...
#       sensor_raw == "kPa",
#       1L,
#       as.integer(str_extract(sensor_raw, "\\d+")) + 1L
#     )
#   ) %>%
...
# soil_daily_long <- soil_daily_long |> left_join(box_meta |> select(-date) |> unique())
# 
# 
# # --- Plot Soil
# 
...
#   facet = "soil",
#   style = "band",
#   # ylab = expression(log[10](psi~"_soil (kPa)")),
#   # ylab = "phi_soil (Pa)",
#   ylab = expression(psi~"(Pa)"),
